...
{
    private const string UserSecretsId = "Reve.CLI";
    private const string UserSecretApiKeyName = "REVE_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"REVE_API_KEY"];
    private const string CredentialFileDirectoryName = ".reve";

    public static async global::System.Threading.Tasks.Task<global::Reve.ReveClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Reve.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Reve.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Reve.ReveClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Reve.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Reve.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Reve.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Reve.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("REVE_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Reve.ApiException exception)
    {
        var builder = new StringBuilder();
