...
internal static class CliRuntime
{
    ...
    public static async Task<global::Reve.ReveClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Reve.ApiException exception)
    {
        var builder = new StringBuilder();
