...
internal static partial class RemixImageCommandApiCommand
{
    ...
    private static Option<global::System.Collections.Generic.IList<string>> ReferenceImages { get; } = new(
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Reve.RemixImageRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var referenceImages = parseResult.GetRequiredValue(ReferenceImages);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.RemixImageAsync(
                                    prompt: prompt,
